    ...
    <>
      <div className="py-0.5 flex justify-between draggable">
        <div className="inline-flex">
          ...
          <p className="text-xs md:pt-1 md:-ml-1 lg:-ml-2">Code snippet manager</p>
        </div>
      ...
      <div className="bg-gray-900 text-white undraggable">
        <div className="flex text-center">
          <div className="text-sm w-8 hover:bg-gray-700 cursor-pointer">File</div>
          <div className="text-sm w-8  hover:bg-gray-700 cursor-pointer">Edit</div>
          <div className="text-sm w-10 hover:bg-gray-700 cursor-pointer">View</div>
          <div className="text-sm w-14 hover:bg-gray-700 cursor-pointer">Window</div>
          <div className="text-sm w-9 hover:bg-gray-700 cursor-pointer">Help</div>
        </div>
      </div>
    </>
  );
